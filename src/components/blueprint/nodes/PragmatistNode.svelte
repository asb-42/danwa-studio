...
>
  ...
  <div class="node-header">
    ...
    <span class="node-type-label">Pragmatist</span>
  </div>

  <div class="node-body">
    <span class="node-name">{data?.label || 'Pragmatist'}</span>
    {#if isLinked}
